              ...
              <React.Fragment key={index}>
                {testimonials.map((testimonial) => (
                  ...
                  >
                    ...
                    <div className="mt-4 md:mt-6 text-sm md:text-base max-h-32 overflow-x-auto -thin pr-2">
                      {testimonial.text}
                    </div>
                  </Card>
                ))}
